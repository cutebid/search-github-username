...
let searchResult = document.querySelector(".search-result-container");
let toggleImage = document.querySelector("#toggle-light");
let text = document.querySelector(".item-container-toggle-para");
    ...
    .then((user) => {
      if(user){
            ...
            <div class="search-result-right">
              <div class="search-result-right-heading">
                <div class = 'right'>
                   <h2> ${user.login} </h2>
              ...
              <div class="search-result-right-media">
                <div class="search-result-right-media-left">
                  <a href="#" class="search-result-right-media-item">
                    <svg
                      class = 'svg-icon'
                      height="20"
                      width="14"
                  ...
                  <a href="#" class="search-result-right-media-item item">
                    <svg
                     class = 'svg-icon'
                      height="20"
                      width="20"
                ...
                <div class="search-result-right-media-right">
                  <a href="#" class="search-result-right-media-item">
                    <svg
                      height="18"
                      width="20"
                    ...
                    <span class="not-active">${user.twitter_username} </span>
                  </a>
                  <a href="#" class="search-result-right-media-item item">
                    <svg
                    class = 'svg-icon'
...
searchBtn.addEventListener("click", showUserName);

toggleImage.addEventListener("click", () => {
  document.body.classList.toggle("light-theme");
  if (document.body.classList.contains("light-theme")) {
    toggleImage.src = "./assets/icon-moon.svg";
    text.innerHTML = "Dark";
  } else {
    toggleImage.src = "./assets/icon-sun.svg";
